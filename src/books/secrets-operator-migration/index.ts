...
class SecretsOperatorMigrator implements RunBook {
  ...
  async Run(): Promise<void> {
    const fromCluster = await this.stp.Cluster(
      'Which cloud do you want to migrate infisical from?',
      'Which cluster do you want to migrate infisical from?',
    );
    const toCluster = await this.stp.Cluster(
      'Which cloud do you want to migrate infisical to?',
      'Which cluster do you want to migrate infisical to?',
    );
